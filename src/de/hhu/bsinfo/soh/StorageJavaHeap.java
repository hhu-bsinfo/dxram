...
public class StorageJavaHeap implements Storage {
	...
	public int readShorts(final long p_ptr, final short[] p_array, final int p_arrayOffset, final int p_length) {
		...
		for (int i = 0; i < p_length; i++) {
			short v = 0;
			v |= ((short) (m_memory[(int) ptr++] & 0xFF)) << 8;
			v |= ((short) (m_memory[(int) ptr++] & 0xFF));

			p_array[i + p_arrayOffset] = v;
		}
	...
	public int readInts(final long p_ptr, final int[] p_array, final int p_arrayOffset, final int p_length) {
		...
		for (int i = 0; i < p_length; i++) {
			int v = 0;
			v |= ((int) (m_memory[(int) ptr++] & 0xFF)) << 24;
			v |= ((int) (m_memory[(int) ptr++] & 0xFF)) << 16;
			v |= ((int) (m_memory[(int) ptr++] & 0xFF)) << 8;
			v |= ((int) (m_memory[(int) ptr++] & 0xFF));
	...
	public int readLongs(final long p_ptr, final long[] p_array, final int p_arrayOffset, final int p_length) {
		...
		for (int i = 0; i < p_length; i++) {
			int v = 0;
			v |= ((long) (m_memory[(int) ptr++] & 0xFF)) << 56L;
			v |= ((long) (m_memory[(int) ptr++] & 0xFF)) << 48L;
			v |= ((long) (m_memory[(int) ptr++] & 0xFF)) << 40L;
			v |= ((long) (m_memory[(int) ptr++] & 0xFF)) << 32L;
			v |= ((long) (m_memory[(int) ptr++] & 0xFF)) << 24L;
			v |= ((long) (m_memory[(int) ptr++] & 0xFF)) << 16L;
			v |= ((long) (m_memory[(int) ptr++] & 0xFF)) << 8L;
			v |= ((long) (m_memory[(int) ptr++] & 0xFF));
	...
	public int writeShorts(final long p_ptr, final short[] p_array, final int p_arrayOffset, final int p_length) {
		...
		long ptr = p_ptr;
		for (int i = 0; i < p_length; i++) {
			m_memory[(int) ptr++] = (byte) ((p_array[i] >> 8) & 0xFF);
			m_memory[(int) ptr++] = (byte) ((p_array[i]) & 0xFF);
		}
	...
	public int writeInts(final long p_ptr, final int[] p_array, final int p_arrayOffset, final int p_length) {
		...
		long ptr = p_ptr;
		for (int i = 0; i < p_length; i++) {
			m_memory[(int) ptr++] = (byte) ((p_array[i] >> 24) & 0xFF);
			m_memory[(int) ptr++] = (byte) ((p_array[i] >> 16) & 0xFF);
			m_memory[(int) ptr++] = (byte) ((p_array[i] >> 8) & 0xFF);
			m_memory[(int) ptr++] = (byte) ((p_array[i]) & 0xFF);
		}
	...
	public int writeLongs(final long p_ptr, final long[] p_array, final int p_arrayOffset, final int p_length) {
		...
		long ptr = p_ptr;
		for (int i = 0; i < p_length; i++) {
			m_memory[(int) ptr++] = (byte) ((p_array[i] >> 56L) & 0xFF);
			m_memory[(int) ptr++] = (byte) ((p_array[i] >> 48L) & 0xFF);
			m_memory[(int) ptr++] = (byte) ((p_array[i] >> 40L) & 0xFF);
			m_memory[(int) ptr++] = (byte) ((p_array[i] >> 32L) & 0xFF);
			m_memory[(int) ptr++] = (byte) ((p_array[i] >> 24L) & 0xFF);
			m_memory[(int) ptr++] = (byte) ((p_array[i] >> 16L) & 0xFF);
			m_memory[(int) ptr++] = (byte) ((p_array[i] >> 8L) & 0xFF);
			m_memory[(int) ptr++] = (byte) ((p_array[i]) & 0xFF);
		}
