 ...
 */
public class NIOMessageImporterOverflow extends AbstractMessageImporter {
     ...
     * Constructor
     */
    public NIOMessageImporterOverflow() {
    ...
    @Override
    public void importObject(final Importable p_object) throws ArrayIndexOutOfBoundsException {
    ...
    @Override
    public int readBytes(final byte[] p_array) throws ArrayIndexOutOfBoundsException {
        return readBytes(p_array, 0, p_array.length);
    }

    @Override
    public int readBytes(final byte[] p_array, final int p_offset, final int p_length) throws ArrayIndexOutOfBoundsException {
    ...
    @Override
    public int readShorts(final short[] p_array) throws ArrayIndexOutOfBoundsException {
        return readShorts(p_array, 0, p_array.length);
    }

    @Override
    public int readInts(final int[] p_array) throws ArrayIndexOutOfBoundsException {
        return readInts(p_array, 0, p_array.length);
    }

    @Override
    public int readLongs(final long[] p_array) throws ArrayIndexOutOfBoundsException {
        return readLongs(p_array, 0, p_array.length);
    }

    @Override
    public int readShorts(final short[] p_array, final int p_offset, final int p_length) throws ArrayIndexOutOfBoundsException {
    ...
    @Override
    public int readInts(final int[] p_array, final int p_offset, final int p_length) throws ArrayIndexOutOfBoundsException {
        for (int i = 0; i < p_length; i++) {
    ...
    @Override
    public int readLongs(final long[] p_array, final int p_offset, final int p_length) throws ArrayIndexOutOfBoundsException {
        for (int i = 0; i < p_length; i++) {
    ...
    @Override
    public byte[] readByteArray() throws ArrayIndexOutOfBoundsException {
    ...
    @Override
    public short[] readShortArray() throws ArrayIndexOutOfBoundsException {
    ...
    @Override
    public int[] readIntArray() throws ArrayIndexOutOfBoundsException {
    ...
    @Override
    public long[] readLongArray() throws ArrayIndexOutOfBoundsException {
    ...
    @Override
    public String[] readStringArray() throws ArrayIndexOutOfBoundsException {
