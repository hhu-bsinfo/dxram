...
public class TaskContextData implements Importable, Exportable {
	 ...
	 * Constructor
	 *
	 * @param p_computeGroupId Compute group id the task is assigned to.
	 * @param p_slaveId        Id of the slave the task is assigned to.
	 * @param p_slaveNodeIds   List of node ids of all involved slaves with this task
	 */
	public TaskContextData(final short p_computeGroupId,
			final short p_slaveId, final short[] p_slaveNodeIds) {
