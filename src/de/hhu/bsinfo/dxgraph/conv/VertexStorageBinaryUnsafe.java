...
class VertexStorageBinaryUnsafe implements VertexStorage {
    ...
    VertexStorageBinaryUnsafe() {
        ...
        Thread t = new Thread() {
            ...
            public void run() {
                while (true) {
                    System.out.println("MemoryConsumptionStorage (MB): " + storage.getTotalMemoryDataStructures() / 1024 / 1024);
                    try {
                        Thread.sleep(1000);
    ...
    public void putNeighbour(final long p_vertexId, final long p_neighbourVertexId) {
        ...
        while (true) {
            ...
            if (m_unsafe.compareAndSwapInt(null, ptrBlock + tableEntryIndex * MS_ENTRY_SIZE_BYTES, entryHeader, entryHeader | 0x80000000)) {
                entryHeader |= 0x80000000;
                break;
            }
        ...
        if (!m_unsafe.compareAndSwapInt(null, ptrBlock + tableEntryIndex * MS_ENTRY_SIZE_BYTES, entryHeader, (sizeOld + 1))) {
