...
abstract class AbstractConverter extends AbstractMain {
    ...
    private static final Argument ARG_MAX_BUFFER_QUEUE_SIZE = new Argument("maxBufferQueueSize", "100000", true,
            "Max size of the buffer queue for the file reader");
     ...
     */
    protected abstract AbstractFileReaderThread createReaderInstance(final String p_inputPath, final BinaryEdgeBuffer p_buffer);
     ...
     */
    protected abstract AbstractFileWriterThread createWriterInstance(final String p_outputPath, final int p_id, final long p_idRangeStartIncl,
    ...
    private int parse(final String... p_inputPaths) {
        ...
        for (String inputPath : p_inputPaths) {
            AbstractFileReaderThread thread = createReaderInstance(inputPath, m_sharedBuffer);
            thread.start();
