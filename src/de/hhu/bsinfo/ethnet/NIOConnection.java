...
class NIOConnection extends AbstractConnection {
     ...
     */
    @Override protected void doWrite(final AbstractMessage p_message) throws NetworkException {
     ...
     *         the AbstractMessage to send
     */
    @Override protected void doForceWrite(final AbstractMessage p_message) throws NetworkException {
        writeToChannelForced(p_message.getBuffer());
    }

    @Override protected boolean dataLeftToWrite() {
        boolean ret;
    ...
    @Override protected boolean isIncomingQueueFull() {
        return m_messageCreator.isFullLazy();
    }

    @Override protected String getInputOutputQueueLength() {
        String ret = "";
     ...
     */
    @Override protected void doCloseGracefully() {
