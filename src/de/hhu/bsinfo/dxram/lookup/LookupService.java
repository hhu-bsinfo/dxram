...
import de.hhu.bsinfo.dxram.lookup.tcmds.TcmdPrintMetadataSummary;
import de.hhu.bsinfo.dxram.lookup.tcmds.TcmdPrintMetadataSummaryAllSuperpeers;
...
public class LookupService extends AbstractDXRAMService implements MessageReceiver {
	...
	protected boolean startService(final de.hhu.bsinfo.dxram.engine.DXRAMEngine.Settings p_engineSettings,
		...
		m_terminal.registerCommand(new TcmdPrintMetadataSummary());
		m_terminal.registerCommand(new TcmdPrintMetadataSummaryAllSuperpeers());
