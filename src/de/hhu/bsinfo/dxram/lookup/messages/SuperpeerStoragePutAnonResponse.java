 ...
 */
public class SuperpeerStoragePutAnonResponse extends AbstractResponse {
    /**
     ...
     *     the request
     */
    public SuperpeerStoragePutAnonResponse(final SuperpeerStoragePutAnonRequest p_request) {
