...
public class ReplaceBackupPeerRequest extends AbstractRequest {
	 ...
	 */
	public ReplaceBackupPeerRequest(final short p_destination, final long p_firstChunkIDOrRangeID,
			final short p_failedBackupPeer, final short p_newBackupPeer, final boolean p_isBackup) {
