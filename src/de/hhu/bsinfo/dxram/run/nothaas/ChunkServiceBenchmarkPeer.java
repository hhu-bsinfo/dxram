...
public class ChunkServiceBenchmarkPeer extends DXRAMMain {
	...
	private static final Argument ARG_NUM_CHUNKS =
			new Argument("numChunks", "1000", true, "Total number of chunks involved in the test");
	private static final Argument ARG_BATCHES = new Argument("batches", "10", true,
			"Split the total number of chunks into a number of batches for get and put operations");
