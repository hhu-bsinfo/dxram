 ...
 *         28.07.2014
 */
public final class LogTest2 implements Runnable {
	 ...
	 */
	private LogTest2(final short p_nodeID, final int p_id) {
		m_nodeID = p_nodeID;
		m_id = p_id;
	}
	...
	public static void main(final String[] p_arguments) {
		...
		for (int i = 0; i < m_numberOfThreads; i++) {
			...
			threads[i] = new Thread(new LogTest2(nodes[i], i));
			threads[i].start();
		}
	...
	public void run() {
		...
		} catch (final DXRAMException e) {// | InterruptedException e) {
