...
public abstract class DXRAMComponent 
{
    ...
    * @param p_class Class of the component to get. If a component has multiple implementations, always use the base class/interface here.
    * @return Reference to the component requested or null if not available/enabled.
    */
   protected <T extends DXRAMComponent> T getDependentComponent(final Class<T> p_class)
   {		   	   
