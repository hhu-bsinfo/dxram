...
public class TimeUnitGsonSerializer implements JsonDeserializer<TimeUnit>, JsonSerializer<TimeUnit> {
    @Override public TimeUnit deserialize(final JsonElement p_jsonElement, final Type p_type, final JsonDeserializationContext p_jsonDeserializationContext)
    ...
    @Override public JsonElement serialize(final TimeUnit p_timeUnit, final Type p_type, final JsonSerializationContext p_jsonSerializationContext) {
