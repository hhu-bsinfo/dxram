...
import de.hhu.bsinfo.utils.StatisticsManager.OperationStatistic;
...
public final class ChunkStatistic implements Statistic {
	...
	public enum Operation {
		CREATE(PREFIX_CREATE, POSITION_CREATE), MULTI_CREATE(PREFIX_MULTI_CREATE, POSITION_MULTI_CREATE), GET(PREFIX_GET, POSITION_GET), MULTI_GET(
				...
				POSITION_INCOMING_GET), INCOMING_MULTI_GET(PREFIX_INCOMING_MULTI_GET, POSITION_INCOMING_MULTI_GET),
		INCOMING_PUT(PREFIX_INCOMING_PUT,
				POSITION_INCOMING_PUT), INCOMING_REMOVE(PREFIX_INCOMING_REMOVE, POSITION_INCOMING_REMOVE), INCOMING_LOCK(PREFIX_INCOMING_LOCK,
				POSITION_INCOMING_LOCK), INCOMING_UNLOCK(PREFIX_INCOMING_UNLOCK, POSITION_INCOMING_UNLOCK), INCOMING_COMMAND(PREFIX_INCOMING_COMMAND,
				POSITION_INCOMING_COMMAND);
