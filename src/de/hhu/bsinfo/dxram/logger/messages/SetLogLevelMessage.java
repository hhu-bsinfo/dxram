...
public class SetLogLevelMessage extends AbstractMessage {
	 ...
	 * @param p_logLevel    Log level to set on remote node
	 */
	public SetLogLevelMessage(final short p_destination, final int p_logLevel) {
	...
	protected final void writePayload(final ByteBuffer p_buffer) {
		p_buffer.putInt(m_logLevel);
	}

	@Override
	protected final void readPayload(final ByteBuffer p_buffer) {
		m_logLevel = p_buffer.getInt();
	}
