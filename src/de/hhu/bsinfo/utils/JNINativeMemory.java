...
public final class JNINativeMemory {
	 ...
	 */
	public static native void readShorts(final long p_addr, short[] p_array, final int p_arrayOffset,
			final int p_length);
	 ...
	 */
	public static native void writeShorts(final long p_addr, short[] p_array, final int p_arrayOffset,
			final int p_length);
	 ...
	 */
	public static native void writeLongs(final long p_addr, long[] p_array, final int p_arrayOffset,
			final int p_length);
