...
public final class JNIconsole {
	 ...
	 *
	 * @param p_commands Commands to be used for autocomplete
	 */
	 ...
	 *
	 * @param p_str String to add to the history.
	 */
	public static native void addToHistory(final String p_str);
