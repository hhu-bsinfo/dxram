...
public class NativeMemoryTest extends AbstractMain {
    ...
    protected int main(final ArgumentList p_arguments) {
...

        {
            ...
            if (v != v2) {
                System.out.println("ERROR: Verifying write short failed: " + Integer.toHexString(v) + " != " + Integer.toHexString(v2));
                return -4;
            }
        }

        {
            ...
            if (v != v2) {
                System.out.println("ERROR: Verifying write int failed: " + Integer.toHexString(v) + " != " + Integer.toHexString(v2));
                return -5;
            }
        }

        {
            ...
            if (v != v2) {
                System.out.println("ERROR: Verifying write long failed: " + Long.toHexString(v) + " != " + Long.toHexString(v2));
                return -6;
            }
        }
