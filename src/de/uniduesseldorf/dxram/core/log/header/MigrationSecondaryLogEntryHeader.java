...
/**
 * Implements a log entry header for a migration secondary log
 * @author Kevin Beineke
 *         25.06.2015
 */
public class MigrationSecondaryLogEntryHeader implements LogEntryHeaderInterface {
	// Attributes
	...
	// Constructors
	/**
	 * Creates an instance of MigrationSecondaryLogEntryHeader
	 */
	public MigrationSecondaryLogEntryHeader() {}

	// Methods
	@Override
	public short getNodeID(final byte[] p_buffer, final int p_offset) {
		return (short) ((p_buffer[0] & 0xff) + ((p_buffer[1] & 0xff) << 8));
	}
	...
	public byte getRangeID(final byte[] p_buffer, final int p_offset) {
		System.out.println("No RangeID in MigrationSecondaryLogEntryHeader!");
		return -1;
	}

	@Override
	public short getSource(final byte[] p_buffer, final int p_offset) {
		System.out.println("No source in MigrationSecondaryLogEntryHeader!");
		return -1;
	}
