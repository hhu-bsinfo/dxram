...
public interface LogInterface extends CoreComponent {
	 ...
	 *             if the secondary log buffer could not be returned
	 */
	SecondaryLogBuffer getSecondaryLogBuffer(short p_nodeID, boolean p_set) throws IOException, InterruptedException;
	 ...
	 *             if the secondary log could not be returned
	 */
	SecondaryLogWithSegments getSecondaryLog(short p_nodeID, boolean p_set) throws IOException, InterruptedException;
	 ...
	 *             if the Chunks could not be read
	 */
	void recoverRange(short p_nodeID, long p_low, long p_high) throws DXRAMException;
	 ...
	 */
	byte[][] readAllEntries(short p_nodeID, boolean p_manipulateReadPtr) throws DXRAMException;
