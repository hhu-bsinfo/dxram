...
public final class MemoryManager {
	 ...
	 *
	 * @param p_nodeID ID of the node this manager is running on.
	 */
	 ...
	 * @param p_chunkID ChunkID of the chunk.
	 * @return Size of the chunk or -1 if the chunkID was invalid.
	 * @throws MemoryException If getting the size of the chunk failed.
	 */
	 ...
	 * This is an access call and has to be locked using lockAccess().
	 * @param p_chunkID ChunkID of the chunk.
	 * @param p_buffer Buffer to copy the payload to.
	 * @param p_offset Start offset within the buffer.
	 * @param p_length Number of bytes to get.
	 * @return Number of bytes written to buffer.
	 * @throws MemoryException If reading chunk data failed.
	 */
	 ...
	 * @throws MemoryException If reading version failed.
	 */
	 ...
	 * This is a management call and has to be locked using lockManage().
	 * @param p_chunkID ChunkID of the chunk.
	 * @param p_buffer Buffer with data to put.
	 * @param p_offset Start offset within the buffer.
	 * @param p_length Number of bytes to put.
	 * @return Number of bytes put/written to the chunk.
	 * @throws MemoryException If writing data failed.
	 */
	 ...
	 * @param p_address Address to write the version to.
	 * @param p_version Version number to write.
	 * @throws MemoryException If writing the version failed.
	 */
	 ...
	 * @param p_address Address to read version from.
	 * @return Version read or -1 if reading version failed or invalid version.
	 * @throws MemoryException If reading version from memory failed.
	 */
	 ...
	 * @param p_version Version to store.
