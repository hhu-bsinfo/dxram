 ...
 *         13.06.2013
 */
public final class OIDTree2 implements Serializable {

	// Constants
	private static final long serialVersionUID = 7565597467331239020L;

	private static final int RANGE_SIZE = 2500000;// Core.getConfiguration().getIntValue(ConfigurationConstants.LOOKUP_INIT_RANGE);
	 ...
	 *            order of the btree
	 */
	public OIDTree2(final short p_order) {
