...
public class CmdUtils {
	 ...
	 *             if an error occured
	 */
	public static short get_NID_from_string(String p_str) throws NumberFormatException {
		short NID;
	...
	public static short get_NID_from_tuple(String p_str) throws NumberFormatException {
		...
		if (CID==null) throw new NumberFormatException();
	 ...
	 *             if an error occured
	 */
	public static long get_LID_from_tuple(String p_str) throws NumberFormatException {
		long LID;
		
		String CID[] = p_str.split(",");
		if (CID==null) throw new NumberFormatException();
		if (CID.length!=2) throw new NumberFormatException();
	 ...
	 */
	public static long calc_CID(short p_NID, long p_LID) {
	 ...
	 *             if an error occured
	 */
	public static long get_CID_from_tuple(String p_str) throws NumberFormatException {
	 ...
	 *             if an error occured
	 */
	public static String get_tuple_from_CID_string(String p_str)  throws NumberFormatException {
	 ...
	 */
	public static String checkNID(String p_NID) {
		String res = "unknown";
	 ...
	 */
	public static boolean mustBePeer(short p_NID, String p_error_string) {
	 ...
	 */
	public static boolean mustBeSuperpeer(short p_NID, String p_error_string) {
		String NIDok = checkNID(Short.toString(p_NID));
