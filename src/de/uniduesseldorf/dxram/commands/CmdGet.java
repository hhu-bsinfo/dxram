...
public class CmdGet extends Cmd {
	...
	public String get_name()          {   return "get";   }
	public String get_usage_message() {   return "get NID,LID [destNID]";   }
	public String get_help_message()  {   return "Get data of chunk NID,LID.\nOptionally, the request can be sent to node destNID (must not be a superpeer).\nImportant: Only a maximum of 100 byte of data is transfered.";   }
	public String get_syntax()        {   return "get PNID,PNR [ANID]";   }
