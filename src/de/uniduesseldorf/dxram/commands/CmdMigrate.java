...
public class CmdMigrate extends Cmd {
	...
	public String get_name()          {   return "migrate";   }
	public String get_usage_message() {   return "migrate NID,LID destNID";   }
	public String get_help_message()  {   return "Migrate chunk NID,LID to destination node destNID";   }
	public String get_syntax()        {   return "migrate PNID,PNR PNID";   }
	...
	public String remote_execute(String p_command) {
		...
		try {
			...
			if (ret==false) return "  error: migration failed";
			else  			return "  Chunk migrated.";
		} catch (final DXRAMException e) {
