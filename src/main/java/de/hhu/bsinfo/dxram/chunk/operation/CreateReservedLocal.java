...
public class CreateReservedLocal extends AbstractOperation {
    ...
    public int create(final int p_offset, final int p_count, final long[] p_addresses, final AbstractChunk... p_chunks) {
        ...
        final AbstractChunk[] selected_chunks = Arrays.copyOfRange(p_chunks, p_offset, p_offset + p_count - 1);
        int created = m_chunk.getMemory().createReserved().createReserved(selected_chunks, p_addresses);
