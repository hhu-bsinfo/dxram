...
public class ResizeResponse extends Response {
    ...
    /**
     * Creates an instance of ResizeResponse.
     ...
     *         the request
     * @param p_statusCodes
     *         Status code for every resize operation
     */
    public ResizeResponse(final ResizeRequest p_request, final byte... p_statusCodes) {
        super(p_request, ChunkMessages.SUBTYPE_RESIZE_RESPONSE);
