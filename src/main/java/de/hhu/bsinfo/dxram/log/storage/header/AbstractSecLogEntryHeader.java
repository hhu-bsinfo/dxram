...
public abstract class AbstractSecLogEntryHeader extends AbstractLogEntryHeader {
    ...
    /**
     * Returns whether the chunk has been migrated/recovered.
     *
     * @return whether the chunk has been migrated/recovered.
     */
     ...
     * @return the maximum log entry header size for secondary log
     */
    private static short getApproxSecLogHeaderSize(final boolean p_logStoresMigrations, final int p_size) {
