...
public class ChunkServiceGetPutWithBackupTest {
    ...
    public void setup() {
        ...
        ChunkTestUtils.createChunks(m_instance, m_cidRanges, false, ChunkTestConstants.CHUNK_SIZE_1, 1000);
        ChunkTestUtils.createChunks(m_instance, m_cidRanges, true, ChunkTestConstants.CHUNK_SIZE_1, 1000);
    }

    @Test
    public void test() {
        ChunkTestUtils.putAndGetAll(m_instance, m_cidRanges, ChunkTestConstants.CHUNK_SIZE_1);
    }
}
